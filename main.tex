...
\begin{align}
	\left( - \frac{\nabla^2}{2m} + V(x) \right) \psi (x) = E_l \psi (x)~.
...
\end{align}
the probability density for a given eigenstate $\psi$ must share the periodicity of the potential,
\begin{align}
	\left\lvert \psi (x + a) \right\rvert^2 = \lvert \psi (x) \rvert^2~.
\end{align}
...
\end{align}
is a unique map from the domain $x \in [0, a)$ to the complex unit circle $\set{z \in \mathds C : \lvert z \rvert = 1}$. We therefore formulate the
\begin{thm}[Bloch]
