...
\REM{Notation: Maybe $H^{\rm e}$ instead of $H^0$?}
...
The expectation value of Eq.\,\eqref{eq:Vext} is a functional of the density,
\begin{align}
	V^{\rm ext} 
...
\REM{Hohenberg Kohn map only unique for ground state densities -> Dreizler/Gross p. 33}
