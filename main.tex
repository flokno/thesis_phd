...
\input{./parts/2_heat_transport.tex}

\chapter{Anharmonicity}
\input{./parts/anharmonicity.tex}

% \part{Benchmarks?}

% \part{Results}
\chapter{Screening Materials for Anharmonicity}
\input{./parts/screening.tex}
...
\begin{figure}
	\includegraphics[width=\textwidth]{./plots/defects/cui/sigma_vs_time.pdf}
	\caption{describe}
	\label{}
\end{figure}

\begin{figure*}
	\includegraphics[width=.5\textwidth]{./plots/defects/cui/perfect_110_solid.png} \hfill
	\includegraphics[width=.5\textwidth]{./plots/defects/cui/defect_110.png}
...
\begin{figure*}
	\includegraphics[width=.5\textwidth]{./plots/defects/cui/defects_110.png} \hfill
	\includegraphics[width=.5\textwidth]{./plots/defects/cui/defects_110_135.png}
