...
The aim of this work is to open a new pathway for overcoming the problem of limited data by devising a route to systematically scan material space for thermal insulators and calculate their thermal conductivities from first principles.

The route is twofold: After reviewing the relevant theoretical tools necessary to model heat transport in thermal insulators, 

The challenge of finding new thermal insulators
