...
\addbibresource{references_experiments.bib}

\usepackage{hyperref}[bookmarksnumbered=true]
\usepackage[numbered]{bookmark}
\usepackage{xpatch}
\hypersetup{
  colorlinks,
  pdfstartview = XYZ null null 1.00,% x y zoom
  pdfstartpage = 1
}
...
\newcommand{\CONTINUE}
{\todo[inline,backgroundcolor=yellow1, bordercolor=white]{{\bf Continue here.} \today}}
