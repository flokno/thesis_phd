...
\newthought{We use the shorthand notation $s = (b, \b q)$ and $-s = (b, - \b q)$} in the following to keep the formulas simple. We explicitly refer to the band index $b$ and the wavenumber $\b q$ when necessary.\footnote{The explicit formulas are given in appendix~\ref{app:ha.formulas}.}
