...
\begin{align}
	...
	\label{eq:lattice.T}
\end{align}
where $a_0$ is the 0\,K static lattice matrix\footnote[][0em]{Lattice matrix: $$a = \begin{pmatrix} \b a_1, \b a_2, \b a_3 \end{pmatrix}~,$$ where $\set{\b a_i}$ are the lattice vectors.}, and $a (T)$ is the lattice at finite temperature given in terms of a \emph{strain transformation} $\varepsilon (T)$. 
