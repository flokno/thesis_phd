...
\begin{align}
	...
	\label{eq:Liouville}
\end{align}
where $L$ is the \emph{Liouville operator} defined by its action according to Eq.\,\eqref{eq:L}, and $\set{\cdot , \cdot}$ denotes the \emph{Poisson bracket} defined by~\CITE{Goldbach}
\begin{align}
	\set{B, H}
