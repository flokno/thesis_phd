...
\begin{marginfigure}
	...
	\includegraphics[width=\textwidth]{./plots/anharmonicity/1_pes_sketch/sketch_vertical.pdf}
...
\begin{marginfigure}
	\includegraphics[width=\textwidth]{./plots/anharmonicity/2_materials/both.pdf}
	\caption{
		\label{fig:KCaF3}
...
\begin{figure}
	\includegraphics[width=\textwidth]{./plots/anharmonicity/3_bandstructures/Si/bands_dos_emb.pdf}
	\caption{
...
\begin{figure}
	\includegraphics[width=\textwidth]{./plots/anharmonicity/3_bandstructures/KCaF3/bands_dos_emb.pdf}
	\caption{
...
\begin{figure}
	\includegraphics[width=\textwidth]{./plots/anharmonicity/4_force_distribution/histogram_forces.pdf}
	\caption{
...
\begin{figure}
	\includegraphics[width=\textwidth]{./plots/anharmonicity/5_density_plots/histogram_harmonic.png}
	\caption{
...
\begin{figure}
	\includegraphics[width=\textwidth]{./plots/anharmonicity/5_density_plots/histogram.png}
	\caption{
...
\begin{figure}
	\includegraphics[width=\textwidth]{./plots/anharmonicity/5_density_plots/histogram_atoms.pdf}
	\caption{
		Normalized anharmonic force components versus normalized force components. Dashed horizontal lines: Width of the distribution estimated from standard deviation.
	}
\end{figure}
...
\begin{figure}
	\includegraphics[width=\textwidth]{./plots/anharmonicity/3_bandstructures/KCaF3.cub/bands_dos_emb.pdf}
	\caption{
...
\begin{figure}
	\includegraphics[width=\textwidth]{./plots/anharmonicity/6_phase_transition/sigma_temp_annot.pdf}
	\caption{
		Normalized anharmonic force components versus normalized force components. Dashed horizontal lines: Width of the distribution estimated from standard deviation.
	}
\end{figure}