...
In order to proceed, we follow the original argument by Kohn and Sham~\cite{Kohn1965} and investigate the universal functional $F[n]$ in more detail. 
