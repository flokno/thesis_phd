...
\cite{Bulou1980,Hidaka1984,Knight2005}
...
\begin{marginfigure}
	\includegraphics[width=\textwidth]{./data/plots/defects/062.05.KCaF3/ref_2.png}
...
\cite{strock1934,strock1935,strock1936,hoshino1957,Brenner2020}
...
\begin{marginfigure}
	...
	\caption{AgI viewed in (100) direction. Top: High-symmetry wurtzite structure. Middle: Silver ions move into interstitial sites along (001) direction when $\sigmaA (t) \approx 1.3$. Bottom: The same configuration viewed along (001) direction.}
	\label{fig:defects.AgI.1}
\end{marginfigure} 

\newpage
\subsection{AgCl}
\cite{lowndes1972,andreoni1983,batchelor1995}
...
\begin{marginfigure}
	...
	\caption{Pair distribution function for up to four coordination shells for MgO for comparison.}
