...
Last but not least, lattice-dynamics techniques can be coupled with molecular dynamics simulations to extract fully anharmonic properties such as phonon lifetimes,~e.\,g.,~as we use them in the \emph{ab initio} Green Kubo method~\cite{Ladd.1986,Turney.200986,Zhang.2014,Carbogno.2016,Glensk.2019} -- the opportunities for combining these approaches are certainly not exhausted.
